...
* 오브젝트 스토리지 백업으로 복원 시, 버전 오류면 Event에 남기도록 수정
* 성능 지표 수집 항목 추가
* 백업 삭제 실패 시, 어떤 작업으로 인한 실패 인지 에러 메시지를 좀 더 상세하게 노출하도록 수정
* 예정된 하이퍼바이저 마이그레이션을 RDS for MS-SQL 웹콘솔에서 진행 할 수 있도록 기능 추가
